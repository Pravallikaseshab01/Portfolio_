...
const CertificationsSection = () => {
  const certificationCategories = [
    {
      ...
      count: 4,
      certifications: [
        { name: "Oracle Cloud Infrastructure Fundamentals", status: "Certified" },
        { name: "Microsoft AZ-900", status: "Certified" },
        { name: "Microsoft DP-900", status: "Certified" },
        { name: "Microsoft AI-900", status: "Certified" }
      ]
    },
    {
      ...
      count: 4,
      certifications: [
        { name: "Java (NPTEL)", status: "Certified" },
        { name: "SQL (365 Data Science)", status: "Certified" },
    ...
    },
    {
      ...
      certifications: [
        ...
        { name: "Generative AI (Google)", status: "Certified" },
        { name: "TensorFlow Certification", status: "Certified" }
      ]
    },
    {
      ...
      certifications: [
        ...
        { name: "ServiceNow Business Process Analyst", status: "Certified" }
      ]
    }
  ];
  ...
  const summaryStats = [
    ...
    { number: "4", label: "Programming Certs" },
    { number: "3", label: "AI/ML Certifications" },
      ...
      <div className="portfolio-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          {certificationCategories.map((category, index) => (
            <div
              key={index}
              className={`bg-white rounded-xl p-8 border border-border card-hover ${category.bgColor}`}
            ...
            >
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">({category.count} Certifications)</p>
                </div>
              </div>
